...
public class DateSceneSpawner : MonoBehaviour
{
    ...
    public void CloneSizeAndLocation()
    {
        ...
        //        Location = new Vector3(-0.64f, 1.85f, 0);
        //        Scale = new Vector3(75f, 75f);
        //        break;
        //    case 6:
        ...
        //        break;
        //    case 13:
        //        Location = new Vector3(0f, 1.85f, 0);
        //        Scale = new Vector3(62f, 62f);
        //        break;
        //    case 14:
        ...
        print("location is currently" + tempSpawnedAlien.transform.position);
    }
}